  ...
  return (
    <>
      <Group
        ...
        onTap={(e) => onSelect(e)}
        onDragStart={(e: KonvaEventObject<DragEvent>) => setShowMenu(false)}
        onDragEnd={(e) => {
          setShowMenu(true);
        ...
        onTransformStart={(e: KonvaEventObject<DragEvent>) =>
          setShowMenu(false)
        }
        onTransformEnd={(e) => {
          setShowMenu(true);
          ...
          {showMenu && (
            <Html
              divProps={{
                style: {
                  position: "absolute",
                  top: `${groupRef.current?.getClientRect().y! - 50}px` || 0,
                  left: `${groupRef.current?.getClientRect().x!}px` || 0,
                },
              }}
            >
